                ...
                <div className="mainCard">
                  <h1 className="text-4xl font-semibold text-center">Join to our social <br />med<span className="text-5xl">IA</span></h1>
                    ...
                    <div className="providers flex flex-col gap-4 mt-14 mb-4 md:flex-row md:gap-2">
                        ...
                        <button type="button" className="text-white bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-4 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55">
