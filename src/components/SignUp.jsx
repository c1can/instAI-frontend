...
export function SignUp() {
    ...
    const { signInWithGmail, signInWithGithub } = useAuth()
                ...
                <div className="mainCard">
                  <h1 className="text-4xl font-semibold text-center mb-10">Join to our social <br />med<span className="text-5xl">IA</span></h1>
                    ...
                    <form>
                        <div className="names flex flex-col md:flex-row md:gap-4 mb-4">
                            ...
                            <div className="in">
                                ...
                                <input type="text" name="lastName" id="lastName" className="block p-2 rounded-lg border border-gray-400 outline-none w-full"/>
                            </div>
                        </div>
                            <label htmlFor="email" className="text-xl text-gray-700">Email</label>
                            <input type="email" id="email" className="block p-2 rounded-lg border border-gray-400 outline-none w-full mb-4"/>
                            <label htmlFor="password" className="text-xl text-gray-700">Password</label>
                            <input type="password" id="password" className="block p-2 rounded-lg border border-gray-400 outline-none w-full"/>
                    ...
                    <div className="providers flex flex-col gap-4 mb-4 md:flex-row md:gap-2 md:justify-center">
                        ...
                        <button onClick={signInWithGmail} type="button" className="text-white bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-4 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55">
